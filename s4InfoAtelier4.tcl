...
#
# s4InfoAtelier4.xpr.tcl: Tcl script for re-creating project 's4InfoAtelier4'
#
...
proc checkRequiredFiles { origin_dir} {
 ...
 "[file normalize "$origin_dir/s4InfoAtelier4.srcs/sources_1/imports/ips/mycolorRegister_1.0/drivers/mycolorRegister_v1_0/src/mycolorRegister.h"]"\
 "[file normalize "$origin_dir/s4InfoAtelier4.srcs/sources_1/imports/ips/rgb2dvi/src/ClockGen.vhd"]"\
 "[file normalize "$origin_dir/s4InfoAtelier4.srcs/sources_1/imports/ips/rgb2dvi/src/OutputSERDES.vhd"]"\
 "[file normalize "$origin_dir/s4InfoAtelier4.srcs/sources_1/imports/ips/rgb2dvi/src/rgb2dvi.vhd"]"\
 "[file normalize "$origin_dir/s4InfoAtelier4.srcs/sources_1/imports/ips/mycolorRegister_1.0/example_designs/bfm_design/mycolorRegister_v1_0_tb.sv"]"\
 "[file normalize "$origin_dir/s4InfoAtelier4.srcs/sources_1/imports/ips/pixelDataToVideoStream_1.0/hdl/pixelDataToVideoStream_v1_0_M00_AXIS.vhd"]"\
 "[file normalize "$origin_dir/s4InfoAtelier4.srcs/sources_1/imports/ips/pixelDataToVideoStream_1.0/drivers/pixelDataToVideoStream_v1_0/src/pixelDataToVideoStream.h"]"\
 "[file normalize "$origin_dir/s4InfoAtelier4.srcs/sources_1/imports/ips/rgb2dvi/src/SyncAsync.vhd"]"\
 "[file normalize "$origin_dir/s4InfoAtelier4.srcs/sources_1/imports/ips/pixelDataToVideoStream_1.0/example_designs/bfm_design/pixelDataToVideoStream_v1_0_tb.sv"]"\
 "[file normalize "$origin_dir/s4InfoAtelier4.srcs/sources_1/imports/ips/rgb2dvi/src/SyncAsyncReset.vhd"]"\
 "[file normalize "$origin_dir/s4InfoAtelier4.srcs/sources_1/imports/ips/rgb2dvi/src/TMDS_Encoder.vhd"]"\
 "[file normalize "$origin_dir/s4InfoAtelier4.srcs/sources_1/imports/ips/mycolorRegister_1.0/hdl/mycolorRegister_v1_0.vhd"]"\
 "[file normalize "$origin_dir/s4InfoAtelier4.srcs/sources_1/imports/ips/rgb2dvi/src/DVI_Constants.vhd"]"\
 "[file normalize "$origin_dir/s4InfoAtelier4.srcs/sources_1/imports/ips/mycolorRegister_1.0/hdl/mycolorRegister_v1_0_S00_AXI.vhd"]"\
 "[file normalize "$origin_dir/s4InfoAtelier4.srcs/sources_1/imports/ips/pixelDataToVideoStream_1.0/hdl/pixelDataToVideoStream_v1_0.vhd"]"\
 "[file normalize "$origin_dir/s4InfoAtelier4.srcs/sources_1/imports/ips/pixelDataToVideoStream_1.0/hdl/pixelDataToVideoStream_v1_0_S00_AXI.vhd"]"\
 "[file normalize "$origin_dir/s4InfoAtelier4.srcs/constrs_1/imports/new/atelier4Constraints.xdc"]"\
  ]
  foreach ifile $files {
...
set script_file "s4InfoAtelier4.xpr.tcl"
...
set files [list \
 [file normalize "${origin_dir}/../../../s4InfoAtelier4/s4InfoAtelier4.srcs/sources_1/imports/new/testPatternGen2.vhd"]\
 [file normalize "${origin_dir}/s4InfoAtelier4.srcs/sources_1/imports/ips/mycolorRegister_1.0/drivers/mycolorRegister_v1_0/src/mycolorRegister.h"]\
 [file normalize "${origin_dir}/s4InfoAtelier4.srcs/sources_1/imports/ips/rgb2dvi/src/ClockGen.vhd"]\
 [file normalize "${origin_dir}/s4InfoAtelier4.srcs/sources_1/imports/ips/rgb2dvi/src/OutputSERDES.vhd"]\
 [file normalize "${origin_dir}/s4InfoAtelier4.srcs/sources_1/imports/ips/rgb2dvi/src/rgb2dvi.vhd"]\
...
set file "src/mycolorRegister.h"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
...
set file "bfm_design/mycolorRegister_v1_0_tb.sv"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj

set file "hdl/pixelDataToVideoStream_v1_0_M00_AXIS.vhd"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "src/pixelDataToVideoStream.h"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog Header" -objects $file_obj
...
set file "bfm_design/pixelDataToVideoStream_v1_0_tb.sv"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj
...
set file "hdl/mycolorRegister_v1_0.vhd"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj
...
set file "hdl/mycolorRegister_v1_0_S00_AXI.vhd"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "hdl/pixelDataToVideoStream_v1_0.vhd"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj

set file "hdl/pixelDataToVideoStream_v1_0_S00_AXI.vhd"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "VHDL" -objects $file_obj
...
set file "[file normalize ${origin_dir}/../../../s4InfoAtelier4/s4InfoAtelier4.srcs/constrs_1/imports/new/atelier4Constraints.xdc]"
...
# Proc to create BD atelier4
proc cr_bd_atelier4 { parentCell } {
...
# testPatternGen2
  ...
  grams:gramslib:mycolorRegister:1.0\
  grams:gramslib:pixelDataToVideoStream:1.0\
...
# End of cr_bd_atelier4()
cr_bd_atelier4 ""
set_property REGISTERED_WITH_MANAGER "1" [get_files atelier4.bd ]
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files atelier4.bd ]


# Create wrapper file for atelier4.bd
make_wrapper -files [get_files atelier4.bd] -import -top
...
set obj [get_runs synth_1]
set_property -name "auto_incremental_checkpoint.directory" -value "/home/jeep/C:/Users/Julien/Documents/vivado/s4InfoAtelier4/s4InfoAtelier4.srcs/utils_1/imports/synth_1" -objects $obj
...
set obj [get_runs impl_1]
set_property -name "auto_incremental_checkpoint.directory" -value "/home/jeep/C:/Users/Julien/Documents/vivado/s4InfoAtelier4/s4InfoAtelier4.srcs/utils_1/imports/impl_1" -objects $obj
